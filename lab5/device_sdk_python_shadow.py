...
def send():
    ...
    mqtt_connection.publish("data/temperature", message, 0)
    ...
    if MOTOR_STATUS == "ON":
        ...
        message = json.dumps(message)
        mqtt_connection.publish("data/vibration", message, 0)
...
if __name__ == '__main__':
    ...
    #mqttShadowClient = AWSIoTMQTTShadowClient(args.thing_name)
